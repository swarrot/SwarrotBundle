                        ...
                        ->children()
                            ...
                            ->arrayNode('ssl_options')
                                ->children()
                                    ...
                                    ->scalarNode('verify_peer_name')
                                        ->validate()
                                            ->ifNotInArray([true, false, null])
                                            ->thenInvalid('Invalid value "%s" for option "verify_peer_name" bool|null expected')
                                        ->end()
                                    ->end()
                                    ->scalarNode('allow_self_signed')
                                        ->validate()
                                            ->ifNotInArray([true, false, null])
                                            ->thenInvalid('Invalid value "%s" for option "allow_self_signed" bool|null expected')
                                        ->end()
                                    ->end()
